...
const itemsMarkup = createImgMarkup(galleryItems);
...
function onImgClick(e) {
    ...
    bigPicture.src = `${imgEl.dataset.source}`;
    bigPicture.alt = `${imgEl.alt}`;

    modal.classList.add('is-open');
}

const closeModal = document.querySelector('button[data-action="close-lightbox"]');
closeModal.addEventListener('click', onCrossClick);
